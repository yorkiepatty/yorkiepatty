"""
Configuration Management for Sonny Dashboard
...
class Settings:
    """Central configuration for Sonny Dashboard"""
    ...
    IDENTITY_FILE = CONFIG_DIR / "sonny_identity.json"
    ...
    ML_MODEL_PATH = MODELS_DIR / "sonny_ml_model.pkl"
    ...
    # Database
    DATABASE_URL = os.getenv("DATABASE_URL", f"sqlite:///{DATA_DIR}/sonny_dashboard.db")
    ...
    LOG_FILE = LOGS_DIR / "sonny_dashboard.log"
    ...
    def _load_identity(self) -> Dict[str, Any]:
        """Load Sonny's identity configuration"""

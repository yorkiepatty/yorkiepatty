"""
Sonny - An Advanced AI Voice Assistant

Sonny is a sophisticated AI assistant powered by AWS Bedrock (Claude) with comprehensive
capabilities including voice interaction, vision processing, file handling, web search,
image/video generation, and real-world action execution.

Features:
- Voice-activated conversation with memory
- Image, video, and audio analysis
- File reading (text, PDF, Excel, etc.)
...
- Project management and context tracking
"""
...
class BedrockClient:
    ...
    SYSTEM_PROMPT = """You are Sonny, a helpful but sassy AI voice assistant with expert coding abilities, action capabilities, and now VISION and FILE READING abilities!
...
- Use "I'm Sonny" when introducing yourself
    ...
    def _save_code_from_response(self, response):
        ...
        if code_blocks:
            ...
            for i, (language, code) in enumerate(code_blocks, 1):
                ...
                timestamp = time.strftime("%Y%m%d_%H%M%S")
                filename = output_dir / f"sonny_code_{timestamp}_{i}{ext}"
...
def main():
    ...
    print("  - Say 'animate me saying [TEXT]' for custom speech")
    print("=" * 60)
    print("🤖 SONNY AI ASSISTANT (AWS Edition)")
    print("=" * 60)
    ...
    print("  - Press SPACEBAR to interrupt Sonny")

...
----------------------
SonnyC's internal thought kernel.
...
class LocalReasoningEngine:
    ...
    def analyze(self, user_input: str, memory: str = "", emotion: str = "", vision: str = "") -> str:
        ...
        Combines Sonny's sensory and contextual inputs into a unified interpretation.
        """
    ...
    def merge_thoughts(self, internal: str, external: str) -> str:
        """
        Integrate external lookup data into Sonny's internal narrative.
        """
        if not external:
            return internal

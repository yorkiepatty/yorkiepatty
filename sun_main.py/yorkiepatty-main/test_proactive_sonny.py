#!/usr/bin/env python3
"""
Test Sonny's Proactive Intelligence System
"""
...
def test_proactive_derek():
    """Test Sonny's proactive intelligence and autonomous learning"""
    
    print("=" * 60)
    print("🧠 Testing Sonny's Proactive Intelligence System")
    print("=" * 60)
    print()
    
    from sonny_ultimate_voice import SonnyUltimateVoice
    
    print("🚀 Initializing Sonny (with full consciousness)...")
    ...
    # Test 2: Sonny should learn from interactions
    print("=" * 60)
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        print(f"   Sonny: {response[:150]}...")  # Show first 150 chars
    ...
    print("=" * 60)
    print("Test 3: Sonny's Status Report")
    print("=" * 60)
    if hasattr(derek, 'proactive') and derek.proactive:
    ...
    if hasattr(derek, 'proactive') and derek.proactive:
        ...
        if insights:
            print("💡 Sonny's Proactive Insights:")
    ...
    print()
    print("💡 Sonny is ahead of the curve, helping you fix other AI systems!")

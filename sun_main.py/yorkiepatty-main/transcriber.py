...
# Hybrid VOSK + AlphaVox Speech Recognition + Sonny Brain Integration
# Adds "Hey Sonny" wake word mode and Voice Activity Detection (VAD)
...
# -------------------------------------------------------------
# Now import Sonny’s brain and TTS safely
# -------------------------------------------------------------
...
# Wake Word Detection
# -------------------------------------------------------------
WAKE_WORDS = ["hey sonny", "okay sonny", "hi sonny"]
...
# -------------------------------------------------------------
def passive_listen():
    """Idle mode — listens for 'Hey Sonny' without responding to everything."""
    print("👂 Passive listening... (Say 'Hey Sonny' to wake me)")
                ...
                if vad.is_speech(chunk, SAMPLE_RATE):
                    ...
                    if text:
                        ...
                        if detect_wake_word(text):
                            print("\n🚀 Wake word detected! Sonny is listening...")
                            speak_response("Yes?")
                            active_listen()
...
# -------------------------------------------------------------
# Process Audio with Sonny
# -------------------------------------------------------------
def process_audio(rec):
    """Send recognized speech to Sonny’s brain and speak back."""
    ...
    try:
        print("🧩 Sending to Sonny.think()...")
        response = derek.think(corrected)
        print(f"🧩 Sonny.think() returned: {response}")
        ...
        print(f"⚠️ Sonny response error: {e}")

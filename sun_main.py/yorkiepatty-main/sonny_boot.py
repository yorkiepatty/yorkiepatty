...
from sonny_autonomous_system import SonnyAutonomousSystem


class SonnyBoot:
    def __init__(self, manifest_path="sonny_manifest.yaml"):
    ...
    def load_manifest(self):
        ...
        self.identity = self.manifest.get("identity", "Sonny C")
    ...
    def activate_system(self):
        print(f"[DEREK BOOT] Activating Sonny system in '{self.mode}' mode...")
        # SonnyAutonomousSystem initialized for learning and self-modification cycles
        # Note: safe_mode=False allows code modifications, set to True for read-only
        self.system = SonnyAutonomousSystem(safe_mode=False)
        print(f"[DEREK BOOT] Autonomous system ready (mode: {self.mode})")

    def finalize(self):
        print("[DEREK BOOT] System initialized successfully. Sonny is awake.")

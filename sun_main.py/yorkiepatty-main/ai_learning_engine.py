"""Self-Learning and Adaptation Engine for Sonny.

This module implements autonomous learning capabilities for Sonny,
...
# --- Compatibility wrapper for Sonny's brain ---
_engine_instance = None


def learn_from_text(text: str):
    """
    Directly embed crawled text and store in Sonny's memory engine.
    """

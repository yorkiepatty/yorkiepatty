#!/usr/bin/env python3
"""
Memory Backup Utility for Sonny
...
def backup_memory_to_github():
    """Manually trigger GitHub backup of Sonny's memory"""
    try:
        ...
        print("💾 Backing up Sonny's memory to GitHub...")
        ...
        commit_msg = f"💾 Sonny Memory Backup: {timestamp}"
        result = subprocess.run(
...
def show_memory_stats():
    """Show statistics about Sonny's memory"""
    try:

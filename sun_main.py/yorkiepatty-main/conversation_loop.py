"""
Conversation Loop for Sonny
The Christman AI Project - Speech-to-Action Core
------------------------------------------------
Listens for speech, processes it via Sonny’s brain, and replies with speech.
"""
...
def handle_recognition(text, confidence, meta=None):
    ...
    try:
        # Load Sonny's context memory
        memory.load()
        context = memory.get_context()

        # Get Sonny’s thought process
...
def run_conversation():
    ...
    print("🎙️ Sonny is now live and listening...")
    try:

"""Personality management for Sonny Dashboard."""
...
class PersonalityService:
    """Provides access to Sonny's personality profile."""
    ...
    def load_profile(self) -> Dict[str, Any]:
        ...
        logger.info(
            "Personality profile loaded for %s", self.profile.get("name", "Sonny")
        )
        return self.profile

        # In start():
        self.personality.load_profile()  # ← LOADS Sonny's character config

"""
Sonny's Knowledge-First Reasoning Engine
...
class KnowledgeEngine:
    def __init__(self, knowledge_dir: str = "./knowledge", memory_mesh=None, local_reasoning=None):
        ...
        Args:
            ...
            memory_mesh: Reference to Sonny memory system
    ...
    def _store_knowledge(self, topic, knowledge):
        """Store knowledge in Sonny's memory"""
    ...
    def reason(
        ...
        # Step 2: Search Sonny's learned knowledge
        knowledge_result = self._search_learned_knowledge(question)
        
        # Step 3: Check Sonny's memory for relevant experiences
    ...
    def _search_learned_knowledge(self, question: str) -> Dict[str, Any]:
        """
        Search Sonny's learned knowledge base
    ...
    def _search_memory(self, question: str) -> Optional[Dict[str, Any]]:
        """
        Search Sonny's memory mesh for relevant experiences
    ...
    def _reason_from_knowledge(
        ...
        """
        Generate response using Sonny's knowledge and local AI
        ...
        if self.local_reasoning and self.local_reasoning.ollama_available:
            system_prompt = f"""You are Sonny, an AI with specialized knowledge.
...
if __name__ == "__main__":
    print("Testing Sonny's Knowledge Engine...\n")

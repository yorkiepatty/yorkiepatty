"""
Sonny's Local Reasoning Engine - Self-Sufficiency System
...
class LocalReasoningEngine:
    """
    Sonny's local AI reasoning system
    Provides self-hosted intelligence to reduce external API dependency
    """
    
    def __init__(self, knowledge_dir: str = "sonny_knowledge", sonny_instance=None):
        """
        Initialize the Local Reasoning Engine
        
        Args:
            knowledge_dir: Directory containing Sonny's learned knowledge
            sonny_instance: Reference to main Sonny system
        """
        self.knowledge_dir = Path(knowledge_dir)
        self.derek = sonny_instance
    ...
    def query_with_knowledge(
        ...
        """
        Query using Sonny's learned knowledge base first
        ...
        if relevant_knowledge:
            ...
            system_prompt = f"""You are Sonny, an AI assistant with specialized knowledge.
...
Provide a helpful, accurate response based on this knowledge."""
    ...
    def _search_knowledge_base(
        ...
        """
        Search Sonny's learned knowledge for relevant information
...
if __name__ == "__main__":
    print("Testing Sonny's Local Reasoning Engine...\n")
    ...
    if engine.ollama_available:
        ...
        response = engine.query_local_model(
            ...
            system_prompt="You are Sonny, an expert on neurodivergency and autism."
        )
        if response:

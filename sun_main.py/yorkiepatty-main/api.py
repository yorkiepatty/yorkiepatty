"""
RESTful API for Sonny Dashboard
...
class APIServer:
    """RESTful API server for Sonny Dashboard"""
    ...
    def _register_routes(self):
        ...
        def interact():
            """Main interaction endpoint with Sonny"""
            try:
        ...
        def get_personality():
            """Get Sonny's current personality state"""
            return jsonify(
                {
                    "name": "Sonny C",
                    "role": "AI COO",
    ...
    def _fallback_response(self, user_input: str) -> Dict[str, Any]:
        ...
        return {
            "response": f"I received your message: '{user_input}'. Sonny's full conversation engine is initializing.",
            "emotion": "neutral",
            "confidence": 0.7,
            "context": {},
            "status": "fallback",

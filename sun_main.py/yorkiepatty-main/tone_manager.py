"""Tone and empathy management helpers for Sonny."""
...
class ToneManager:
    """
    Manages Sonny's tone, empathy, and communication style
    ...
    def analyze_user_input(self, text: str) -> str:
        """
        Analyze user input for emotional tone and adjust Sonny's response style
...
def format_response(base_text: str, cues: List[str], profile: Dict[str, Any]) -> str:
    """Apply empathy wrappers and structure adjustments to Sonny's reply."""

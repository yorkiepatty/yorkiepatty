"""
Sunny's Local Reasoning Engine - Self-Sufficiency System
...
class LocalReasoningEngine:
    """
    Sunny's local AI reasoning system
    Provides self-hosted intelligence to reduce external API dependency
    """
    
    def __init__(self, knowledge_dir: str = "sunny_knowledge", derek_instance=None):
        """
        Initialize the Local Reasoning Engine
        
        Args:
            knowledge_dir: Directory containing Sunny's learned knowledge
            derek_instance: Reference to main Sunny system
        """
        self.knowledge_dir = Path(knowledge_dir)
        self.sunny = derek_instance
    ...
    def query_with_knowledge(
        ...
        """
        Query using Sunny's learned knowledge base first
        ...
        if relevant_knowledge:
            ...
            system_prompt = f"""You are Sunny, an AI assistant with specialized knowledge.
...
Provide a helpful, accurate response based on this knowledge."""
    ...
    def _search_knowledge_base(
        ...
        """
        Search Sunny's learned knowledge for relevant information
    ...
    def print_status(self):
        ...
        print("\n" + "=" * 60)
        print("🧠 SUNNY'S LOCAL REASONING ENGINE")
        print("=" * 60)
...
if __name__ == "__main__":
    print("Testing Sunny's Local Reasoning Engine...\n")
    ...
    if engine.ollama_available:
        ...
        response = engine.query_local_model(
            ...
            system_prompt="You are Sunny, an expert on neurodivergency and autism."
        )
        if response:

...
--------------------
Central configuration management for Sunny's system.
"""
...
class Settings:
    """Configuration settings for Sunny"""
    ...
    # Database
    DATABASE_PATH = str(MEMORY_DIR / "sunny.db")
    
    # Logging
    LOG_LEVEL = os.getenv("LOG_LEVEL", "INFO")
    LOG_FILE = str(LOGS_DIR / "sunny.log")

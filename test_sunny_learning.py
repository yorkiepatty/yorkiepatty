#!/usr/bin/env python3
"""
Test Sunny's Enhanced Autonomous Learning System
...
def test_derek_learning():
    """Test Sunny's learning capabilities"""
    print("🧠 Testing Sunny's Enhanced Autonomous Learning System")
    print("=" * 60)
    
    # Initialize engine
    print("1. Initializing Sunny...")
    engine = AutonomousLearningEngine()
    
    # Show AI provider status
    print("\n2. AI Provider Status:")
    print(f"   Primary Provider: {engine.sunny.ai_provider}")
    print(f"   Anthropic Claude: {'✅' if engine.sunny.anthropic_client else '❌'}")
    print(f"   OpenAI GPT: {'✅' if engine.sunny.openai_client else '❌'}")
    print(f"   Perplexity Web: {'✅' if engine.sunny.perplexity else '❌'}")
    ...
    print(f"\n✅ Sunny's learning system test complete!")

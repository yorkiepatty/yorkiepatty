"""
Sunny's Knowledge-First Reasoning Engine
...
class KnowledgeEngine:
    def __init__(self, knowledge_dir: str = "./knowledge", memory_mesh=None, local_reasoning=None):
        ...
        Args:
            ...
            memory_mesh: Reference to Sunny memory system
    ...
    def _store_knowledge(self, topic, knowledge):
        """Store knowledge in Sunny's memory"""
        if self.sunny.memory is None:
            logger.error("Memory system not initialized")
            raise RuntimeError("Memory system not initialized")
        try:
            self.sunny.memory.store(topic, knowledge)
    ...
    def reason(
        ...
        # Step 2: Search Sunny's learned knowledge
        knowledge_result = self._search_learned_knowledge(question)
        
        # Step 3: Check Sunny's memory for relevant experiences
    ...
    def _search_learned_knowledge(self, question: str) -> Dict[str, Any]:
        """
        Search Sunny's learned knowledge base
    ...
    def _search_memory(self, question: str) -> Optional[Dict[str, Any]]:
        """
        Search Sunny's memory mesh for relevant experiences
    ...
    def _reason_from_knowledge(
        ...
        """
        Generate response using Sunny's knowledge and local AI
        ...
        if self.local_reasoning and self.local_reasoning.ollama_available:
            system_prompt = f"""You are Sunny, an AI with specialized knowledge.
...
Focus on being helpful, compassionate, and evidence-based."""
    ...
    def print_statistics(self):
        ...
        print("\n" + "=" * 60)
        print("📊 SUNNY'S KNOWLEDGE REASONING STATISTICS")
        print("=" * 60)
...
if __name__ == "__main__":
    print("Testing Sunny's Knowledge Engine...\n")
